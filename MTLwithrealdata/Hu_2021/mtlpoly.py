...
MTL3 = NeuralNetwork(hidden_nuron1=141, hidden_nuron2=39, hidden_nuron3=36, num_inputs=feature_size)

#LR3 = 0.01
#gamma3 = 1
#step_size3 = 1000
optimizer3 = torch.optim.Adam(MTL3.parameters(), lr=0.008286651903698119, weight_decay= 1.4063442822803792e-07)
