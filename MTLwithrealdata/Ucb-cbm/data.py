...
def data_prepration():
    data = pd.read_csv('/Users/anuragtrivedi/Desktop/MTLwithrealdata/data/uci-cbm/data.csv')
...
#df_new.skew()
    ...
    input_cols = list(df_new.columns)[0:16]
    target_cols1 = list(df_new.columns)[16:17]
    target_cols2 = list(df_new.columns)[17:18]
