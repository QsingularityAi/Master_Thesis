...
def data_prepration():
    ...
    data = pd.read_csv('/Users/anuragtrivedi/Desktop/MTLwithrealdata/Huang_2021/data.csv')
...
#df_new.skew()
    ...
    input_cols = list(df_new.columns)[0:13]
    target_cols1 = list(df_new.columns)[13:14]
    target_cols2 = list(df_new.columns)[14:15]
