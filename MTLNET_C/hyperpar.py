...
class MTL_NetworkC(nn.Module):
    def __init__(self, trial, hidden_layer_size, task_layer1, task_layer2, feature_size, n_output_1=1, n_output_2=1,n_output_3=1):
...
def objective(trial):
    ...
    # Model
    model = MTL_NetworkC(trial, task_layesr1, task_layesr2, hidden_layer_size, feature_size, n_output_1=1, n_output_2=1,n_output_3=1)
    # Optimizer
