...
def objective(trial):
    ...
    hidden_neu_expert = trial.suggest_int('hidden_neu_expert', 0, 40)
    hidden_tower_neu = trial.suggest_int('hidden_tower_neu', 0, 10)
    num_neurons_expert = trial.suggest_int('num_neurons_expert', 1, 90)
