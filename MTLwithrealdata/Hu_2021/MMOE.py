    ...
    def __init__(self, num_experts, num_tasks, num_inputs, num_neurons_expert, num_neurons_expert2, num_neurons_tower):
        ...
        for i in range(num_experts):
            setattr(self, 'expert'+str(i), nn.Sequential(
                ...
                nn.LeakyReLU(),
                nn.Linear(num_neurons_expert, 18),
                nn.ReLU(),
                nn.Linear(18, num_neurons_expert2),
                nn.LeakyReLU()
            ))
        ## Gates
        ...
        for i in range(num_tasks):
            setattr(self, 'tower'+str(i), nn.Sequential(
                nn.Linear(num_neurons_expert2, 4),
                nn.LeakyReLU(),
                nn.Linear(4, num_neurons_tower),
...
MTL1 = MMOE(num_experts=5, num_tasks=3, num_inputs=num_inputs, num_neurons_expert=47,num_neurons_expert2 =14, num_neurons_tower=1)
gamma1 = 1
#step_size1 = 500
optimizer1 = torch.optim.Adam(MTL1.parameters(), lr=0.0032101378930412877, weight_decay= 2.285081013239198e-06)
