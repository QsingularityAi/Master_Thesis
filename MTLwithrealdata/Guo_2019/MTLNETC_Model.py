...
class MTL_NetworkC(nn.Module):
    def __init__(self):
        ...
        self.hidden_layer_2 = nn.Sequential(
                            nn.Linear(hidden_layer_size, 15),
                            nn.ReLU(),
                            nn.Dropout(0.0),
                            nn.Linear(15, 15),
                            nn.ReLU(),
                            nn.Linear(15, n_output_2))
...
gamma2 = 1
step_size2 = 50
optimizer2 = torch.optim.Adam(MTL2.parameters(), lr=0.005443398919199595)
