    ...
    def __init__(self, num_experts, num_tasks, num_inputs, num_neurons_expert, num_neurons_expert2, num_neurons_tower):
        ...
        for i in range(num_experts):
            setattr(self, 'expert'+str(i), nn.Sequential(
                ...
                nn.LeakyReLU(),
                nn.Linear(num_neurons_expert, 6),
                nn.LeakyReLU(),
                nn.Linear(6, num_neurons_expert2),
                nn.LeakyReLU(),
            ))
        ## Gates
...
MTL1 = MMOE(num_experts=4, num_tasks=2, num_inputs=num_inputs, num_neurons_expert=24,num_neurons_expert2 =6, num_neurons_tower=1)
gamma1 = 1
step_size1 = 100
optimizer1 = torch.optim.Adam(MTL1.parameters(), lr=0.048703034474071885, weight_decay = 2.4787482357695797e-06)
