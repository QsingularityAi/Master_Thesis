    ...
    def __init__(self, num_experts, num_tasks, num_inputs, num_neurons_expert, num_neurons_expert2, num_neurons_tower):
        ...
        for i in range(num_experts):
            setattr(self, 'expert'+str(i), nn.Sequential(
                ...
                nn.LeakyReLU(),
                nn.Linear(num_neurons_expert, 13),
                nn.LeakyReLU(),
                nn.Linear(13, num_neurons_expert2),
                nn.LeakyReLU(),
            ))
        ## Gates
        ...
        for i in range(num_tasks):
            setattr(self, 'tower'+str(i), nn.Sequential(
                nn.Linear(num_neurons_expert2, 5),
                # nn.LeakyReLU(),
                nn.ReLU(),
                nn.Linear(5, num_neurons_tower),
...
MTL1 = MMOE(num_experts=3, num_tasks=2, num_inputs=num_inputs, num_neurons_expert=39,num_neurons_expert2 =8, num_neurons_tower=1)
gamma1 = 1
step_size1 = 100
optimizer1 = torch.optim.RMSprop(MTL1.parameters(), lr=0.002, weight_decay = 1.5358836458690578e-10)
