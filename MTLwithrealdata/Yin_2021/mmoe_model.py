...
def objective(trial):
    ...
    hidden_neu_expert = trial.suggest_int('hidden_neu_expert', 1, 10)
    hidden_tower_neu = trial.suggest_int('hidden_tower_neu', 1, 10)
    num_neurons_expert = trial.suggest_int('num_neurons_expert', 1, 30)
    num_neurons_expert2 = trial.suggest_int('num_neurons_expert2', 1, 10)
    # Model
