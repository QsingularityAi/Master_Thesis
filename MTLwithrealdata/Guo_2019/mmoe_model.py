...
def objective(trial):
    ...
    hidden_neu_expert = trial.suggest_int('hidden_neu_expert', 1, 20)
    hidden_tower_neu = trial.suggest_int('hidden_tower_neu', 1, 10)
    num_neurons_expert = trial.suggest_int('num_neurons_expert', 1, 60)
    num_neurons_expert2 = trial.suggest_int('num_neurons_expert2', 5, 16)
    # Model
    model = MMOE(trial, num_experts, num_neurons_expert, hidden_neu_expert, hidden_tower_neu, num_neurons_expert2, num_tasks=3,num_neurons_tower=1, num_inputs=feature_size)
    # Optimizer
